...
/**
 * REST controller for managing {@link com.muyuan.app.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<ApplicationUser> partialUpdateApplicationUser(
        ...
        Optional<ApplicationUser> result = applicationUserRepository
            ...
            .map(existingApplicationUser -> {
                if (applicationUser.getRealName() != null) {
                    existingApplicationUser.setRealName(applicationUser.getRealName());
                }
