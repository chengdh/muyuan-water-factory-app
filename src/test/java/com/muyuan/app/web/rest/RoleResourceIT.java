...
import com.muyuan.app.repository.RoleRepository;
...
class RoleResourceIT {
    ...
    void createRole() throws Exception {
        ...
        assertThat(testRole.getOrderBy()).isEqualTo(DEFAULT_ORDER_BY);
        assertThat(testRole.getNote()).isEqualTo(DEFAULT_NOTE);
        assertThat(testRole.getIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
    }
    ...
    void putExistingRole() throws Exception {
        ...
        updatedRole.name(UPDATED_NAME).code(UPDATED_CODE).orderBy(UPDATED_ORDER_BY).note(UPDATED_NOTE).isActive(UPDATED_IS_ACTIVE);
        ...
        assertThat(testRole.getOrderBy()).isEqualTo(UPDATED_ORDER_BY);
        assertThat(testRole.getNote()).isEqualTo(UPDATED_NOTE);
        assertThat(testRole.getIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
    }
    ...
    void partialUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.code(UPDATED_CODE).note(UPDATED_NOTE);
    ...
    void fullUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.name(UPDATED_NAME).code(UPDATED_CODE).orderBy(UPDATED_ORDER_BY).note(UPDATED_NOTE).isActive(UPDATED_IS_ACTIVE);
